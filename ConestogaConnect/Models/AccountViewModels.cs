...
using static ConestogaConnect.Controllers.AccountController;
...
namespace ConestogaConnect.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [Required]
        [StringLength(50,ErrorMessage = "The {0} must be at least {1} character long.", MinimumLength = 1)]

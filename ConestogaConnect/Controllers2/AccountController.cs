    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, Semester = model.Semester, Program = model.Program, StudentId = model.StudentId, PhoneNumber = model.PhoneNumber };
                ...
                if (result.Succeeded)
                {
                    ...
                    List<EmailAddress> recipient = new List<EmailAddress>();
                    recipient.Add(new EmailAddress(model.Email, model.FirstName + " " + model.LastName));
                    SendEmailViaSendGrid("Confirm your account!", body, recipient);

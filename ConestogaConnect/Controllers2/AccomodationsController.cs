...
namespace ConestogaConnect.Controllers
{
    ...
    public class AccomodationsController : BaseController
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,Number_of_Rooms,Rent,Facilities,PetFriendly,Parking,Floor,Furnished,Posted_Date,Last_Updated,Image_Id,Location,Description")] Accomodation accomodation)
        {
            if (ModelState.IsValid)
            {

...
namespace ConestogaConnect.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName=model.FirstName, LastName = model.LastName, Semester = model.Semester, Program = model.Program ,StudentId=model.StudentId};
                ...
                if (result.Succeeded)
                {
                    ...
                    client.Credentials = new NetworkCredential("sandeepkaur452@gmail.com", "ubersand@25");

                    MailMessage mailMessage = new MailMessage();
                    mailMessage.From = new MailAddress("sandeepkaur452@gmail.com");
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var message = new MailMessage();
                message.To.Add(new MailAddress(model.Email));  
                message.From = new MailAddress("conestogaconnect@info.com");  

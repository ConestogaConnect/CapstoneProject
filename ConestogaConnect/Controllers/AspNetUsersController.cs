...
namespace ConestogaConnect.Controllers
{
    public class AspNetUsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Email,EmailConfirmed,PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName,FirstName,ConfirmedEmail,LastName,Program,Semester,StudentId,ProfileImage")] AspNetUser aspNetUser)
        {
            if (ModelState.IsValid)
            {
